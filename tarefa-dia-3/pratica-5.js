...
while (i < receita.length) {
    totalsemgorjeta = totalsemgorjeta + receita[i].valor
    i += 1
}
console.log(`Total sem gorjeta = ${totalsemgorjeta}`)

// Resposta: Total sem gorjeta = 49796
...
i = 0 
while (i < receita.length) {
    totalcomgorjeta = totalcomgorjeta + receita[i].valor + receita[i].gorjeta
    i += 1
}
console.log(`Total com gorjeta = ${totalcomgorjeta}`)

// Resposta: Total com gorjeta = 54775.60
...
console.log(`Número de vendas abaixo de 50 = ${vendasabaixode50}`)

// Resposta: Número de vendas abaixo de 50 = 4
